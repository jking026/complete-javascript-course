...
// ++ operator needs to be iterated again
let a = 10;
console.log(a++); // => 10
console.log(a++); // => 11
// Prefixed ++ operator
...
// 3. Advanced reduce method to create an object
...
// 4. all words in the string are capitalized except for some
...
console.log(convertTitleCase('and we know the cop and the robber'));
*/
...
*/
// dogs[i].recommendFood = 22 ** 0.75 * 28;
// console.log(dogs);

// for (let i = 0; i < dogs.length; i++) {
//   const recommendedFood = Math.trunc(dogs[i].weight ** 0.75 * 28);
...
// console.log(
//   `${sarahsDog.owners[0]}'s dog is eating too ${
...
// console.log(
//   `${ownersEatTooMuch[0]}, ${ownersEatTooMuch[1]}, and ${ownersEatTooMuch[2]}'s dogs too much!`
// );
// console.log(
//   `${ownersEatTooLittle[0]}, ${ownersEatTooLittle[1]}, and ${ownersEatTooLittle[2]}'s dogs too little!`
// );
// /*
// 5. Log to the console whether there is any dog eating exactly the amount of food
// that is recommended (just true or false)
// */
// // const exactDiet = dogs.some(dogs.curFood === dogs.recFood);
...
// const okayDiet = dogs.filter(
//   dog => dog.curFood > dog.recFood * 0.9 && dog.curFood < dog.recFood * 1.1
// );
// console.log(okayDiet);
// /*
// 8. Create a shallow copy of the 'dogs' array and sort it by recommended food portion in an ascending order (keep in mind that the portions are inside the array's objects )
// */
// // Creates a new array for recFood in an ascending order
// const dogsRecFood = dogs.flatMap(dog => dog.recFood).sort((a, b) => a - b);
// console.log(dogsRecFood);
// // Creates a new array for recFood in an ascending order
