...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    const options = {
      ...
      minute: 'numeric',
      day: 'numeric',
      month: 'numeric', //month: 'long', // March, April etc.
      // month: '2-digit', //03
      year: 'numeric',
      // weekday: 'long', //weekday: 'short', //=> Wed //weekday: 'narrow', // => W
    };
    // retrieves language from browser
...
// keeps counting in the background and moves on
//asynchronous JS
const ingredients = ['olives', 'candy'];
...
// Possible challenge- create a clock
*/
