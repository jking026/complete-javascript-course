...
// Lesson: IMPLEMENTING A STICKY NAVIGATION - THE SCROLL EVENT
/* BAD SOLUTION-BECAUSE IT FIRES OFF EVERYTIME WE SCROLL*/
// Sticky navigation
...
// });
// // LESSON: A BETTER WAY: INTERSECTION OBSERVER API
...
// gets height no matter how small or large the viewport is
...
// PROJECT: REVEALING ELEMENTS ON SCROLL
...
// PROJECT: LAZY LOADING IMAGES
/* Very useful for slow data and old devices*/
...
/////////////// Slider ///////
// Project: Building a SLider Component: Part 1
const slider = function () {
  ...
  //  // allows us to see it while designing
  ...
  //Project: Building a SLider Component: Part 2

  document.addEventListener('keydown', function (e) {
    console.log(e);
    // both the same (short circuiting )
...
//   e.preventDefault(); // some browsers not Chrome
//   console.log(e);
//   e.returnValue = '';
// });
